...
function findById(id, callback) {
  var sql = 'SELECT * FROM screenshot WHERE isDel = 0 AND id = ?';
...
function find(data, callback) {
  var sql = 'SELECT * FROM screenshot WHERE isDel = 0',
    values = [];
...
function save(data, callback) {
  var sql = 'INSERT INTO screenshot SET ?';
...
function update(id, data, callback) {
  var sql = 'UPDATE screenshot set ? WHERE id = ?';
